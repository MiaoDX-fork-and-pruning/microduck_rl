...
| Contact rewards | air-time, terrain-relative clearance, swing, slip, self collision | `velocity_flat_contact` + ContactSensor/raw PhysX view | BLOCKED | foot-site terms, direct mjlab count kernel, concrete 4-env raw views, and forced count unit fixture are covered; a forced-contact numerical runtime fixture remains | task |
